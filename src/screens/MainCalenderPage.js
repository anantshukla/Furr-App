...
import { Context } from './CalenderPages/data/Context.js';
import { Task } from './CalenderPages/components/Task';
import TodoStore from './CalenderPages/data/TodoStore'
          ...
          <>
            ...
            >
              <CalendarStrip
                ...
                iconLeft={require('./CalenderPages/assets/left-arrow.png')}
                iconRight={require('./CalenderPages/assets/right-arrow.png')}
              ...
              >
                <Image
                  source={require('./CalenderPages/assets/plus.png')}
                  style={{
                    height: 30,
                    width: 30,
                  }}
